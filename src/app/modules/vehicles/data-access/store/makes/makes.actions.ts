...
export const searchMakes = createAction(
  '[Makes] Search Makes',
  props<{ searchTerm: string }>()
);

export const clearMakesSearch = createAction(
  '[Makes] Clear Makes Search'
);

export const loadMoreMakes = createAction(
  '[Makes] Load More Makes',
  props<{ page: number }>()
);
...
export const clearSelectedMake = createAction(
  '[Makes] Clear Selected Make'
);
